export const regionesYcomunas = [
  ...
  {
    "region": "Biobío",
    "comunas": ["Concepción", "Coronel", "Chiguayante", "Florida", "Hualqui", "Lota", "Penco", "San Pedro de la Paz", "Santa Juana", "Talcahuano", "Tomé", "Hualpén", "Lebu", "Arauco", "Cañete", "Contulmo", "Curanilahue", "Los Álamos", "Tirúa", "Los Ángeles", "Antuco", "Cabrero", "Laja", "Mulchén", "Nacimiento", "Negrete", "Quilaco", "Quilleco", "San Rosendo", "Santa Bárbara", "Tucapel", "Alto Biobío"]
  },
  {
    "region": "La Araucanía",
...
export const todasLasComunas = regionesYcomunas.flatMap(r => r.comunas).sort();

export const obtenerRegionPorComuna = (comunaNombre: string) => {
  const regionObj = regionesYcomunas.find(r => r.comunas.includes(comunaNombre));
  return regionObj ? regionObj.region : "";
};
